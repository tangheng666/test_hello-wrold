...
<html>
  <head>
	...
	<script type="text/javascript">
	 ...
	 $.ajax({
	  type:"post",
      data:'{"userid":"'+username+'"'+',"password":"'+password+'"'+',"confirmpassword":"'+confirmpassword+'"}',	 
      contentType:"application/json;charset=utf-8",
      url:"http://localhost:8080/Server_Manager_Code/ssd_user/quick_register.action",
      success:function(data){
      $("h1").text("状态码:"+data.retcode+"描述："+data.description );
     //    alert(data);
      }
